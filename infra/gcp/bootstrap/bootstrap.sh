...
echo " Next steps:"
echo "   1. Run: cd infra/gcp/environments/dev && terraform init -backend-config=backend.tf"
echo "   2. Run: terraform apply -var-file=terraform.tfvars"
echo "   3. Record the workload_identity_provider output as GCP_WORKLOAD_IDENTITY_PROVIDER secret"
